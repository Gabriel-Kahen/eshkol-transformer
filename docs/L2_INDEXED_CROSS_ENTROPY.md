...
`1336a4e7e6e75d3033a5c6072bcee430b93451d8a61ebcee8b3f4c08f3c53d31`.
The strict Q0 reader verifies its canonical bytes, checksum, source identity, lock
identity, shapes, dtypes, roles, and tolerances. Python and PyTorch remain only under
`tests/`; production source, header, object, archive, and AOT execution neither
import nor invoke them.
