...
static_assert(std::is_same_v<decltype(et_d2_dataset_open_v1(nullptr, 0)), std::int64_t>);
static_assert(std::is_same_v<decltype(et_d2_dataset_close_v1(nullptr)), std::int64_t>);
static_assert(std::is_same_v<decltype(et_d2_shuffle_window_store_v1(nullptr, 0, 0)),
                             std::int64_t>);
static_assert(std::is_same_v<decltype(et_d2_shuffle_window_load_v1(nullptr, 0)),
                             std::int64_t>);
