...
| TR3 | Trainer state machine and exact resume | M3, L2, O2, D2, C2, E3, SHARED-R2 | [TR3-B loss/gradient bridge implementation](https://github.com/Gabriel-Kahen/eshkol-transformer/issues/116) active; [TR3-O atomic update/clear contract](https://github.com/Gabriel-Kahen/eshkol-transformer/issues/119) frozen at `6872807` and accepted for implementation with exact weight binding, exclusive existing I2 plans and a fixed nonallocating commit tail; [TR3-C joint live restore contract](https://github.com/Gabriel-Kahen/eshkol-transformer/issues/120) under design by its original component owner. Public trainer and joint live restore remain unimplemented. Acceptance still requires one-batch overfit, held-out loss improvement and interrupted/resumed equivalence across complete state | active |
