...
| L3S | [Bounded masked-objective reduction and explicit seeds](L3S_MASKED_OBJECTIVE.md) | L2, K1, Q0; I1/I2 for evidence | #87; accepted six-operation CPU-f32 `[1,2]` contract; independent references, failure atomicity, private AOT and local sanitizer evidence; supported CI and integration pending | active |
| E3 | [Loss, perplexity, token accuracy and validation runner](E3_EVALUATION_PROPOSAL.md) | M3/M3T, D2, L2/L3S; proposed shared no-grad/metric/transaction prerequisites | #99; contract/reachability phase active, independent design reviews and bounded canonical-pin probes; API/topology/ownership decisions remain proposed, no production evaluator or completion claim | active |
