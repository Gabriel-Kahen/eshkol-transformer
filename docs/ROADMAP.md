...
| SHARED-R2 | [Bounded I2/K2/C2 persistence admission](SHARED_R2_PERSISTENCE.md) | I2, K2, C2, M3 | #114; candidate keeps K1 ABI 1.0 and C2 bytes, adds only the five exact rank-two storage-copy shapes, exact K2 live descriptor/report audits, M3 public LOAD/release, and a C4 schema witness; independent review and supported integration CI remain with the root orchestrator | review |
...
| E3 | [Loss, perplexity, token accuracy and validation runner](E3_EVALUATION_PROPOSAL.md) | M3/M3T, D2, L2/L3S; shared guard acceptance, E3 frame, P1/D2 restore and bool metric seams pending | #99; [E3-CG #101 exact shared guard/fixed14 design](E3_SHARED_CALL_CONTRACT.md) accepted by [root decision 5771662657](https://github.com/Gabriel-Kahen/eshkol-transformer/pull/102#issuecomment-5771662657) and merged in PR #102; [bounded shared implementation](M3_SHARED_CALL.md) in PR #105 has independent approval 5772575224 and supported CI 35693360705 at `e3d8566`, with root acceptance and merge pending; [exact E3 private consumer design](E3_PRIVATE_CONTRACT.md), including canonical P1 69-slot prerequisite, accepted by [root verdict 5771845949](https://github.com/Gabriel-Kahen/eshkol-transformer/pull/104#issuecomment-5771845949) and merged in PR #104; explicit consumer dispatch and implementation regressions pending; private-first architecture accepted with conditions 5771430755/5771464954; consolidated exact design and explicit E3-PRIVATE/E3-PRIVATE-R milestones, genuine I2 outputs; [E3-METRICS candidate](e3/E3_METRICS_IMPLEMENTATION.md) passed supported CI 35697784630 at `80d74f8`; combined integration acceptance remains pending; optional public/weighted paths deferred, no runtime/public evaluator or completion claim | active |
...
| G3-C4-N | [Exact C4 forward numerical provider](G3C4_PRIMITIVES.md) | K1, I1, I2; G3-N, N2, N3K, A2 provenance | [#115](https://github.com/Gabriel-Kahen/eshkol-transformer/issues/115); accepted ABI 1.0 with seven capabilities/eight operations/28 exact pairs; standalone implementation with independent approval and complete local LLVM22 compatibility gate (16,194 numerical / 100,116 adversarial / 60,145 carrier checks, 20 mutants, fresh AOT, ASan/UBSan/LSan); supported CI and root integration pending; no C4 model, sampler, transport or generation acceptance | active |
| TR3 | Trainer state machine and exact resume | M3, L2, O2, D2, C2, E3, SHARED-R2 | #116 [private objective bridge candidate](TR3B_OBJECTIVE_BRIDGE.md) is preserved from exact source `071abb72` with independent approval, local compatibility evidence and a passing supported Ubuntu 22.04/LLVM 21.1.8 focused gate. [#119 private O2 update-and-clear candidate](TR3_O_OPTIMIZER_TRANSACTION_PROPOSAL.md) is preserved from exact implementation source `783dc576` with local atomicity, numerical, lifetime and CI-registration evidence. Independent review approved their exact `2006cde` integration with no findings; full supported union CI, combined aggregate, restore, one-batch overfit, held-out improvement and interrupted/resumed equivalence remain pending | review |
