...
artifact_dir="${1:-$(project_build_dir)/o2}"
parent_dir="$(dirname -- "${artifact_dir}")"
mkdir -p "${parent_dir}"
temporary_dir="$(mktemp -d "${parent_dir}/.o2-build.XXXXXX")"
trap 'rm -rf -- "${temporary_dir}"' EXIT

E1B_COMPILER_TIMEOUT_SECONDS="${O2_COMPILER_TIMEOUT_SECONDS:-360}" \
...
cmp "${PROJECT_ROOT}/native/o2_wave2_defined_symbols.txt" \
  "${temporary_dir}/o2_wave2.o.evidence/global-defined.txt"
ar rcsD "${temporary_dir}/libeshkol_transformer_wave2.a" \
  "${temporary_dir}/o2_wave2.o"

mkdir -p "${artifact_dir}"
rm -rf -- "${artifact_dir}/o2_wave2.o.evidence"
mv "${temporary_dir}/o2_wave2.o.evidence" \
  "${artifact_dir}/o2_wave2.o.evidence"
mv -f "${temporary_dir}/o2_wave2.o" "${artifact_dir}/o2_wave2.o"
mv -f "${temporary_dir}/libeshkol_transformer_wave2.a" \
  "${artifact_dir}/libeshkol_transformer_wave2.a"
printf 'built source-composed O2 successor aggregate: %s\n' \
  "${artifact_dir}/libeshkol_transformer_wave2.a"
