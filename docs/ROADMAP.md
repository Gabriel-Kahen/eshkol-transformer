...
| TR3 | [Trainer state machine and exact resume](TR3_P1_FIXED_SET.md) | M3, L2, O2, D2, C2, E3 | Bounded P1 slots69/70 fixed-set capture/recheck leaf preserves the accepted E3 prefix and public surface; frozen-runtime exact zero-allocation/count/retention evidence and independent fresh review approved the leaf; lease registry, O2 overlap, D2 borrow, one-batch overfit, and interrupted/resumed equivalence remain separate | active |
