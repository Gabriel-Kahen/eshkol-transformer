...
| E3 | [Loss, perplexity, token accuracy and validation runner](E3_EVALUATION_PROPOSAL.md) | M3/M3T, D2, L2/L3S; exact shared guard/frame, P1/D2 restore and bool metric seams pending | #99; private-first architecture accepted with conditions 5771430755/5771464954; [exact private design](E3_PRIVATE_CONTRACT.md) proposed; shared issue101/P1 prerequisite acceptance pending; explicit E3-PRIVATE/E3-PRIVATE-R milestones, genuine I2 outputs; optional public/weighted paths deferred, no ABI/runtime/public evaluator or completion claim | active |
