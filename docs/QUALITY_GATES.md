...
- Warning-clean C11 and C++17 consumers, ASan/UBSan and supported-lane LSan, forged/
  stale/cross-owner/active-borrow negatives, injected allocation/read failures, and
  native live-allocation return to baseline.
...
- D1 manifest-last publication and corrupt/missing/mismatched tokenizer/shard
  negatives. Public wrapper and aggregate-boundary gates remain blocked until the
  D2 issue #1 proposal is accepted.
