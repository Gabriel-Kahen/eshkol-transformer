...
| E3 | [Loss, perplexity, token accuracy and validation runner](E3_EVALUATION_PROPOSAL.md) | M3/M3T, D2, L2/L3S; shared guard acceptance, E3 frame and P1/D2 restore pending; bool metric seam accepted | #99; [E3-CG #101 exact shared guard/fixed14 design](E3_SHARED_CALL_CONTRACT.md) accepted by [root decision 5771662657](https://github.com/Gabriel-Kahen/eshkol-transformer/pull/102#issuecomment-5771662657) and merged in PR #102; [bounded shared implementation](M3_SHARED_CALL.md) in PR #105 has independent approval 5772575224 and supported CI 35693360705 at `e3d8566`, with root acceptance and merge pending; [exact E3 private consumer design](E3_PRIVATE_CONTRACT.md), including canonical P1 69-slot prerequisite, accepted by [root verdict 5771845949](https://github.com/Gabriel-Kahen/eshkol-transformer/pull/104#issuecomment-5771845949) and merged in PR #104; explicit consumer dispatch and implementation regressions pending; private-first architecture accepted with conditions 5771430755/5771464954; consolidated exact design and explicit E3-PRIVATE/E3-PRIVATE-R milestones, genuine I2 outputs; [bounded E3-METRICS implementation](e3/E3_METRICS_IMPLEMENTATION.md) accepted at merged union `33a54ef`, tree `2256194`, after supported exact-tree CI 35697784630/35744832879, merged-head topology reuse 35798192984 and independent byte-preservation/ABI review; optional public/weighted paths deferred, no runtime/public evaluator or completion claim | active |
