...
| M3T | [Bounded production Eshkol transport/lifetime proposal](M3T_TRANSPORT_PROPOSAL.md) | N3K, N2, A2, I1, I2, P1L, E1B | #68; [current-main refresh](M3T_REFRESH.md) proposes restricted 85-global sibling and corrected P1 counts; exact amended contract awaiting binding integration acceptance; no implementation or model-completion claim | active |
