...
| C1 | [Versioned checkpoint container and atomic I/O](CHECKPOINT_FORMAT.md) | A0, P1, Q0, E1/E1B | 96 logical-state/ownership/error checks, 992 bounded adversarial validator cases, deterministic repeated AOT bytes, native failpoint/ABI/sanitizer gates, and atomic old-or-new publication evidence; supported CI and approval pending | review |
