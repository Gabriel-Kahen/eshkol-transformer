...
| P1 | [Named parameter tree, buffers, modules, state dictionaries](P1_MODULE_STATE.md) | A0, R0, Q0, E1, E1B | One 23-export registry-owning package, 178 structural/ownership/atomicity checks, 183 native identity/failpoint/cross-role checks, 20 registry/error-mapping checks, exact manifests, import-both/fresh-cache negatives, sanitizers, and deterministic AOT | review |
