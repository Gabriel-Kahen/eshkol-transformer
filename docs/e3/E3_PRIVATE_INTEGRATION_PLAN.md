...
|---|---|---|
| Shared call/pins, [#101 / PR #105](https://github.com/Gabriel-Kahen/eshkol-transformer/pull/105) | `e3d8566eaa33eec2c7fb2a4ef278b1c53b0d3acf`; supported [run 35693360705](https://github.com/Gabriel-Kahen/eshkol-transformer/actions/runs/35693360705), 19 suites / 27 commands | Open; independent root acceptance and merge. GitHub currently reports `DIRTY`; the owner/root must reconcile it without conflating old candidate CI with new-tree evidence. |
