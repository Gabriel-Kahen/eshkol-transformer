...
| P1 | [Named parameter tree, buffers, modules, state dictionaries](P1_MODULE_STATE.md) | A0, R0, Q0, E1 | 157 structural/ownership/atomicity checks, 160 native identity/failpoint/cross-role checks, fresh-cache public-boundary negatives, sanitizers, and deterministic AOT | review |
