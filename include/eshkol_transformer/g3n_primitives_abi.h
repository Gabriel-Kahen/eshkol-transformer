#ifndef ESHKOL_TRANSFORMER_G3N_PRIMITIVES_ABI_H
#define ESHKOL_TRANSFORMER_G3N_PRIMITIVES_ABI_H
#include "eshkol_transformer/kernel_abi.h"
#ifdef __cplusplus
extern "C" {
#endif
#define ET_G3N_PRIMITIVES_ABI_MAJOR 1u
#define ET_G3N_PRIMITIVES_ABI_MINOR 0u
