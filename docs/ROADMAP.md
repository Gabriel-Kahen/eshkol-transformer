...
|---|---|---|---|---|
| F0 | Package layout, build/test entry points, CI matrix | — | Seven full-coverage blocking suites in parallel with an estimated 45–55-minute critical path, plus serial nightly/manual exhaustive acceptance without redundant outer rebuilds on supported Linux | review |
