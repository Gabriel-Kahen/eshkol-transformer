...
| E3 | [Loss, perplexity, token accuracy and validation runner](E3_EVALUATION_PROPOSAL.md) | M3/M3T, D2, L2/L3S; shared guard and bool metric seam accepted; E3 frame and P1/D2 restore pending | #99; [E3-CG #101 exact shared guard/fixed14 design](E3_SHARED_CALL_CONTRACT.md) accepted by [root decision 5771662657](https://github.com/Gabriel-Kahen/eshkol-transformer/pull/102#issuecomment-5771662657) and merged in PR #102; [bounded shared implementation](M3_SHARED_CALL.md) accepted by root 5778924718 after independent approval 5772575224 and documentation-delta review; supported CI 35736728847 passed 19 suites / 27 commands at tree `d5e8a801`, identical to PR #105 merge `19f404cf`; focused merged-head contract/native/sanitizer checks passed; [exact E3 private consumer design](E3_PRIVATE_CONTRACT.md), including canonical P1 69-slot prerequisite, accepted by [root verdict 5771845949](https://github.com/Gabriel-Kahen/eshkol-transformer/pull/104#issuecomment-5771845949) and merged in PR #104; [integration/test inventory](e3/E3_PRIVATE_INTEGRATION_PLAN.md) records candidate evidence and remaining E3-PRIVATE/E3-PRIVATE-R gates; runtime held for final checked-promotion/handler-reserve pin adoption, P1/guard acceptance and explicit root dispatch; prerequisites merged in PR #112 as `33a54ef7` after supported CI 35744832879 passed all 19 suites / 29 commands; private-first architecture accepted with conditions 5771430755/5771464954; consolidated exact design and explicit E3-PRIVATE/E3-PRIVATE-R milestones, genuine I2 outputs; [bounded E3-METRICS implementation](e3/E3_METRICS_IMPLEMENTATION.md) accepted at merged union `33a54ef`, tree `2256194`, after candidate CI 35697784630, supported union CI 35744832879, verified main reuse 35798192984, independent byte-preservation/ABI review and the complete focused merged-head gate; optional public/weighted paths deferred, no runtime/public evaluator or completion claim | active |
| E3-D2 | [Canonical-byte identity and native idle prerequisite](e3/E3_D2_PREREQUISITE.md) | T1, D1, D2; merged PR #104 contract | #106; exact one-form hash-pinned source variant, authentic T1 admission and native idle 0/1/2; private compiled closure, lifecycle, provenance and sanitizer gates; candidate `f10acc9` passed supported CI 35698763745; byte-preserving prerequisite-union PR #112 passed all 19 suites/29 commands in supported CI 35744832879 and merged as `33a54ef7` at the verified tree; focused merged-head component, closure, topology and isolation gates passed; frame restoration, staging, rollback and full E3 composition remain deferred | complete |
| G3 | Greedy, temperature, top-k/top-p generation with KV cache | M3, T1, A2 | #89 [bounded design and compiled reachability](G3_GENERATION_PROPOSAL.md), decision 5748532295; exact G3-N/S ABIs accepted for implementation by decision 5751933660; [exact G3-T private-seam contract](g3/G3_T_PRIVATE_CONTRACT.md) accepted by decision 5752756205; G3-N and shared guards accepted/merged; G3-S platform-blocked review still gates T; [readiness checklist](g3/G3_T_READINESS.md) supplies pending consumer witnesses only; end-to-end generation/save-reload acceptance remains open | active |
...
| SHARED-R2 | [Fixed-model checkpoint storage admission](https://github.com/Gabriel-Kahen/eshkol-transformer/issues/114) | I2, K1, K2, C1, C2 | Root-accepted successor provider/audit contract; implementation active for five exact matrix shapes, genuine K1 copy and public C2 model/tie/moment load/release evidence; no runtime acceptance yet | active |
...
| G3-C4-N | [Four-position generation numerical provider](https://github.com/Gabriel-Kahen/eshkol-transformer/issues/115) | K1, accepted N2/N3K/A2/G3-N numerical contracts | Exact standalone ABI accepted; 28 bounded operation/shape pairs implemented at `b04edf0` with independent review and local compatibility evidence. [Integration PR #122](https://github.com/Gabriel-Kahen/eshkol-transformer/pull/122) at `637cec0` preserves the provider and fixtures; 104 CI tests and the 19-suite / 30-command topology pass; independent union review approves with no findings; supported full CI 35799381054 attempt 1 was canceled at the user-requested pause; attempt 2 is running. Its supported C4 numerical/ABI/two-AOT/sanitizer suite passed, but full-run acceptance remains pending. Full C4 model, continuation and generation persistence remain separate dependencies | active |
| TR3 | Trainer state machine and exact resume | M3, L2, O2, D2, C2, E3, SHARED-R2 | [TR3-B loss/gradient bridge implementation](https://github.com/Gabriel-Kahen/eshkol-transformer/issues/116) active; [TR3-O atomic update/clear contract](https://github.com/Gabriel-Kahen/eshkol-transformer/issues/119) frozen at `6872807` and accepted for implementation with exact weight binding, exclusive existing I2 plans and a fixed nonallocating commit tail; [TR3-C joint live restore contract](TR3_C_LIVE_STATE_CONTRACT.md) at `da872f0` passed independent adversarial review and was [accepted for implementation](https://github.com/Gabriel-Kahen/eshkol-transformer/issues/120#issuecomment-5786680779); its 42-tensor transaction, source-closed staging and distinct target/receiver counters remain to be implemented and verified. Public trainer and joint live restore remain unimplemented. Acceptance still requires one-batch overfit, held-out loss improvement and interrupted/resumed equivalence across complete state | active |
| CLI3 | Corpus, tokenizer, pretrain, evaluate, generate and inspect CLIs | T2, TR3, G3, X1 | [CLI3-A tokenizer/corpus/checkpoint-inspect implementation](https://github.com/Gabriel-Kahen/eshkol-transformer/issues/118) active. No command acceptance yet; pretrain/evaluate/generate await their actual upstream APIs. End-to-end command tests and actionable diagnostics remain required | active |
