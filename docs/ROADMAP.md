...
| C2 | Full training-state checkpoint schema | C1, D2, O2, X1, K2 | Prerequisites merged; private implementation remains under lifetime/operational-bound repair, with public composition, full gates and independent acceptance outstanding. Component continuation and atomic file publication only; TR3 retains joint live restore/full trajectory and G3 generation proof | active |
