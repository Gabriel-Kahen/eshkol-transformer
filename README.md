...
L3S adds no model loss facade or tensor owner. Supported candidate CI passed,
independent L3S-R approved PR #91, and the focused merged-main check passed.
Acceptance closeout awaits combined-main CI and documentation review.
