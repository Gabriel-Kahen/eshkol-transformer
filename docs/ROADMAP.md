...
| D1 | [Versioned token-shard format and corpus writer](TOKEN_SHARD_FORMAT.md) | A0, Q0, E1 | 14 deterministic/reference/corruption/boundary groups, native primitive and production-E1 mapping probes, and repeated strict compile evidence | review |
