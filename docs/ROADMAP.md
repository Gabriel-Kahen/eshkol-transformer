...
| W3-GUARD | Checked-allocation cleanup ordering | M3 shared calls, C2 state borrows, runtime repair #108 | [M3 call guard #117](https://github.com/Gabriel-Kahen/eshkol-transformer/issues/117) has independently reviewed source and passing ordinary compiled package evidence; repaired-runtime handler-failure witness pending. [C2 borrow activation #121](https://github.com/Gabriel-Kahen/eshkol-transformer/issues/121) assigned for rollback-before-publication repair and both activation-prefix failure tests; no new public API or checkpoint format | active |
| G3-C4-N | [Four-position generation numerical provider](https://github.com/Gabriel-Kahen/eshkol-transformer/issues/115) | K1, accepted N2/N3K/A2/G3-N numerical contracts | Exact standalone ABI accepted; implementation and focused tests active for 28 bounded operation/shape pairs. Full C4 model, continuation and generation persistence remain separate dependencies | active |
| TR3 | Trainer state machine and exact resume | M3, L2, O2, D2, C2, E3, SHARED-R2 | [TR3-B loss/gradient bridge implementation](https://github.com/Gabriel-Kahen/eshkol-transformer/issues/116) active; [TR3-O atomic update/clear contract](https://github.com/Gabriel-Kahen/eshkol-transformer/issues/119) and [TR3-C joint live restore contract](https://github.com/Gabriel-Kahen/eshkol-transformer/issues/120) under design by the original component owners. Public trainer and joint live restore remain unimplemented. Acceptance still requires one-batch overfit, held-out loss improvement and interrupted/resumed equivalence across complete state | active |
