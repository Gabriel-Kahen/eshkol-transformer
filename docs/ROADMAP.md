...
|---|---|---|---|---|
| F0 | Package layout, build/test entry points, CI matrix | — | Parallel blocking suites with a 15-minute target, plus nightly/manual exhaustive acceptance on supported Linux | complete |
