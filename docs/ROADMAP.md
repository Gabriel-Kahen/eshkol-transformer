...
| G3 | Greedy, temperature, top-k/top-p generation with KV cache | M3, T1, A2 | #89 [proposed contract and compiled reachability](G3_GENERATION_PROPOSAL.md); C2 diagnostic prerequisite slice awaits disposition; generation, cache/no-cache, sampling and save/reload acceptance remain open | active |
