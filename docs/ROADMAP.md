...
| ID | Workstream | Depends on | Acceptance evidence | Status |
|---|---|---|---|---|
| N3K | [Bounded diagnostic numerical primitives and initializer](N3K_PRIMITIVES.md) | N2, A2, K1, I1, I2, Q0 | Contract accepted on #1 comment 5584383610; independent numerical/oracle and ownership/packaging review; native and supported gates pending | active |
