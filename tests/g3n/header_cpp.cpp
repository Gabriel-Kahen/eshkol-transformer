...
static_assert(ET_G3N_PRIMITIVES_ABI_MAJOR == 1u);
static_assert(ET_G3N_PRIMITIVES_ABI_MINOR == 0u);
static_assert(std::is_same_v<decltype(&et_g3n_kernel_provider_v1),
