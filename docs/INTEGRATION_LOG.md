...
- **Contract accepted:** [integration decision with corrections](https://github.com/Gabriel-Kahen/eshkol-transformer/issues/1#issuecomment-5584383610). Docs now preserve K1 shape-product/address-overflow precedence, distinguish numeric RNG encoding from authenticated algorithm identity/stream separation, and retain downstream schedule enforcement. Implementation and native/supported validation are incomplete at this WIP checkpoint.
