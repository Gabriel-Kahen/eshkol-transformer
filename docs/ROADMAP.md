...
| K2 | Production Eshkol capability-report facade ([issue #73](https://github.com/Gabriel-Kahen/eshkol-transformer/issues/73)) | A0, K1, E1/E1B, I1, I2 | Pre-freeze audit active; existing A0 operations, genuine exact-domain reports, compiled public calls, ownership/isolation negatives and supported CI required; no new capability rows inferred | active |
