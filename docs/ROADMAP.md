...
| TR3 | Trainer state machine and exact resume | M3, L2, O2, D2, C2, E3 | Active decomposition: [#119 private O2 update-and-clear candidate](TR3_O_OPTIMIZER_TRANSACTION_PROPOSAL.md) has local atomicity, numerical, lifetime and CI-registration evidence; combined aggregate, restore, one-batch overfit and interrupted/resumed equivalence remain pending | active |
