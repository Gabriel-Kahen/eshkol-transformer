...
| E3 | [Loss, perplexity, token accuracy and validation runner](E3_EVALUATION_PROPOSAL.md) | M3/M3T, D2, L2/L3S; shared guard and bool metric seam accepted; E3 frame integration and P1/D2 restore pending | #99; the shared-call implementation, E3-METRICS and E3-D2 prerequisite union is accepted at merged `33a54ef` after supported 19-suite/29-command CI and focused merged-head checks. The exact nine-file deterministic reference/oracle toolkit from `37a8078` remains unregistered. The exact five-file bounded native-frame leaf from `38fb989` is independently source-approved; root authenticated its supported normal and ASan/UBSan/LSan runs, each reporting 4,381 checks. This candidate preserves those leaf blobs and registers the standalone gate in the 19-suite/33-command union. Integration review, full CI and root acceptance remain pending. Public evaluator/source composition, final runtime pin adoption, P1/D2 restoration, guard adoption, parity and full evaluator acceptance remain pending | active |
