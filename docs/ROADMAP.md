...
| TR3 | Trainer state machine and exact resume | M3, L2, O2, D2, C2, E3 | [TR3-C live snapshot/joint restore contract proposal](TR3_C_LIVE_STATE_CONTRACT.md) is under root review; implementation remains blocked on accepted private seams and prerequisites. One-batch overfit and interrupted/resumed equivalence | planned |
