...
| G3-C4 | [Four-position generation profile](g3/G3_C4_PROFILE_PROPOSAL.md) | Accepted C2 G3 base, proposed 28-row numerical provider, shared C4 pins and staged ownership | Proposed only; repeated decode/later-token EOS and failure proof; [full G3 decision plan](g3/G3_FULL_ACCEPTANCE_PLAN.md); no runtime dispatch or broader-context claim | proposed |
| G3-R | [Typed data-only model and generation continuation](g3/G3_R_PERSISTENCE_PROPOSAL.md) | G3-C4, shared rank-two storage #114, staged P1/I2 replay and lane manifest | Proposed C4 capsule and SAVE/LOAD; C1/C2 bytes unchanged; exact fresh-process equivalence and ownership proof pending | proposed |
