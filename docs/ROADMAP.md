...
| E3 | [Loss, perplexity, token accuracy and validation runner](E3_EVALUATION_PROPOSAL.md) | M3/M3T, D2, L2/L3S; shared guard implementation, E3 frame, P1/D2 restore and bool metric seams pending | #99; [E3-CG #101 exact shared guard/fixed14 design](E3_SHARED_CALL_CONTRACT.md) accepted by [root decision 5771662657](https://github.com/Gabriel-Kahen/eshkol-transformer/pull/102#issuecomment-5771662657); contract merge/explicit implementation dispatch pending, shared runtime unimplemented/unaccepted and remaining E3 consumer design unaccepted; private-first architecture accepted with conditions 5771430755/5771464954; consolidated exact design and explicit E3-PRIVATE/E3-PRIVATE-R milestones, genuine I2 outputs; optional public/weighted paths deferred, no ABI/runtime/public evaluator or completion claim | active |
